...
/**
 * Color theme configurations for PasswordDialog
 */
const colorThemes = {
  amber: {
 ...
 * Used for project passwords, PDF passwords, ZIP passwords, etc.
 */
const PasswordDialog = memo(function PasswordDialog({
  ...
  const colors = colorThemes[colorTheme] || colorThemes.amber;
  ...
  return (
    <Modal open={open} onClose={onClose}>
      <Modal.Header
        ...
        title={title || t('Password Required')}
        subtitle={subtitle}
      />
      ...
      <Modal.Body>
        ...
        <div className="relative">
          <input
            ...
            className={`w-full px-4 py-2.5 pr-10 border rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 ${colors.focusRing} focus:border-transparent transition-colors ${
              error
