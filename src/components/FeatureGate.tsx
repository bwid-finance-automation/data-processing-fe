 ...
 * @param {string} props.featureKey - The feature key to check (e.g., 'bankStatementOcr')
 * @param {React.ReactNode} props.children - The feature content to render if enabled
 */
