                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-4 mt-2 text-sm text-gray-600 dark:text-gray-400">
                              ...
                              {billing.completed_at && billing.started_at && (
                                <span className="text-xs px-2 py-0.5 bg-gray-200 dark:bg-gray-700 rounded">
                                  ⏱ {Math.round((new Date(billing.completed_at).getTime() - new Date(billing.started_at).getTime()) / 1000)}s
                                </span>
                              )}
                            </div>
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-4 mt-2 text-sm text-gray-600 dark:text-gray-400">
                              ...
                              {comparison.completed_at && comparison.started_at && (
                                <span className="text-xs px-2 py-0.5 bg-gray-200 dark:bg-gray-700 rounded">
                                  ⏱ {Math.round((new Date(comparison.completed_at).getTime() - new Date(comparison.started_at).getTime()) / 1000)}s
                                </span>
                              )}
                            </div>
